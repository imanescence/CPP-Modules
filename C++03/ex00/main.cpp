...
/*   Updated: 2025/02/27 15:31:17 by iait-ouf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)	{
	...
	ClapTrap Simple;  
    	...
    	std::cout << "Hit points: " << Simple.getHitPoints() << std::endl;
    	std::cout << "Energy points: " << Simple.getEnergyPoints() << std::endl;

    	Simple.attack("Simple Victim"); 
	Simple.takeDamage(2);
